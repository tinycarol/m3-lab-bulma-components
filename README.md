...
To kick off, create a new folder `src/components/navbar` and inside create two files:

- `src/components/navbar/Navbar.js` and
...
Following the previous example, create a new folder `src/components/formfield` and inside create two files:

- `src/components/formfield/FormField.js` and
